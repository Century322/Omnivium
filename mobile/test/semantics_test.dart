...
void main() {
  group('SkeletonLoader accessibility', () {
    testWidgets('SkeletonLoader renders without semantics labels', (
      tester,
    ) async {
    ...
    testWidgets('MessageSkeleton renders without semantics labels', (
      tester,
    ) async {
      await tester.pumpWidget(
    ...
    testWidgets('CardSkeleton renders without semantics labels', (
      tester,
    ) async {
      await tester.pumpWidget(
    ...
    testWidgets('ChatListSkeleton renders without semantics labels', (
      tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: ChatListSkeleton(count: 2))),
      );
  ...
  group('Semantics label verification', () {
    testWidgets('Semantics label on GestureDetector is findable', (
      tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('Semantics wrapper provides label for screen readers', (
      tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
