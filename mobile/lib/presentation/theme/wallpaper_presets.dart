...
class WallpaperPresets {
  static const warm = [Color(0xFFFF6B35), Color(0xFFF7931E), Color(0xFFFFD700)];
  ...
  static const dark = [Color(0xFF0D1B2A), Color(0xFF1B2838), Color(0xFF2C3E50)];

  static const pink = [Color(0xFFE91E63), Color(0xFFF06292), Color(0xFFF8BBD0)];
