...
class RuntimeLawEnforcer {
  ...
  List<LawEnforcementResult> get enforcementLog =>
      List.unmodifiable(_enforcementLog);
  ...
  LawEnforcementResult enforceTracing(String sandboxId, bool hasTraceSpan) {
    final result = LawEnforcementResult(
  ...
  LawEnforcementResult enforceBudget(String sandboxId, bool wasBudgetApproved) {
    final result = LawEnforcementResult(
  ...
  List<LawEnforcementResult> violationsFor(String sandboxId) => _enforcementLog
      .where((r) => !r.compliant && r.sandboxId == sandboxId)
      .toList();
