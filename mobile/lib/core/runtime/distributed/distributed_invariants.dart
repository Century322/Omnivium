...
enum CapabilityConsistencyModel {
  stronglyConsistent,
  eventuallyConsistent,
}

enum TimeAuthorityModel {
  wallClock,
  lamportClock,
  hybridLogicalClock,
}
...
class DistributedInvariants {
  static const MessageOrderingModel messageOrdering = MessageOrderingModel.perSessionOrdering;

  static const DeliveryGuarantee capabilityInvokeDelivery = DeliveryGuarantee.atMostOnce;
  static const DeliveryGuarantee eventPropagationDelivery = DeliveryGuarantee.atLeastOnce;
  static const DeliveryGuarantee journalDelivery = DeliveryGuarantee.exactlyOnce;
  ...
  static const TimeAuthorityModel timeAuthority = TimeAuthorityModel.hybridLogicalClock;
  ...
  static List<DistributedInvariant> all() => [
        ...
        const DistributedInvariant(
          ...
          description: 'A session can only have one writer node at any given time. '
              'Session migration transfers ownership atomically.',
          decision: 'Single Writer Principle',
          rationale: 'Concurrent writes to the same session create merge conflicts. '
        ...
        const DistributedInvariant(
          ...
          name: 'Failure Domain',
          description: 'Node failure does not equal runtime failure. '
          ...
          rationale: 'Cascading failures are the #1 killer of distributed systems. '
        ...
        const DistributedInvariant(
          ...
          description: 'The runtime assumes network is always unreliable. '
          ...
          rationale: 'Any system that assumes reliable network will fail in production. '
